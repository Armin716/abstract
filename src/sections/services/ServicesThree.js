    ...
    render() {
        ...
        return(
            <Section id="services">
                <ServiceContainer>
                    <Container>
                        <AnimatedHeading text="Mis Servicios" />
                        <Row>
                            <Col md={4}>
                                <AnimationContainer animation="fadeInLeft" delay={200}>
                                        <ServiceElement>
                                            ...
                                            <ServiceList>
                                                <ServiceListElement>
                                                    Creacion de aplicaciones moviles Android/IOS
                                                </ServiceListElement>
                                            </ServiceList>
                                        </ServiceElement>
                                </AnimationContainer>
                            ...
                            <Col md={4}>
                                    <AnimationContainer animation="fadeInRight" delay={1200}>
                                        <ServiceElement>
                                            ...
                                            <ServiceList>
                                                <ServiceListElement>
                                                    Generalmente me encargo del frontend
                                                </ServiceListElement>
                                            </ServiceList>
                                        </ServiceElement>
                                    </AnimationContainer>
...
export default props => (
    <StaticQuery
      ...
      query {
        ...
        mobile: file(relativePath: {eq: "icons/mobile (2).png"}) {
          childImageSharp {
            fluid(maxWidth: 500) {
              src
            }
        ...
        seo: file(relativePath: {eq: "icons/seo (1).png"}) {
          childImageSharp {
            fluid(maxWidth: 500) {
              src
            }
        ...
        ui: file(relativePath: {eq: "icons/sketch (1).png"}) {
          childImageSharp {
            fluid(maxWidth: 500) {
              src
            }
        ...
        network: file(relativePath: {eq: "icons/network (1).png"}) {
          childImageSharp {
            fluid(maxWidth: 500) {
              src
            }
