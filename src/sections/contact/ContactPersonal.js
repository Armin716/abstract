                  ...
                  <AnimationContainer animation="fadeIn">
                    <FormRow>
                      ...
                      <ContactCol md={6}>
                        <Map  
                          title="map"
                          src="https://maps.google.com/maps?width=500&amp;height=500&amp;hl=en&amp;q=1Mariano%20Escobedo%20105%2C%20General%20Escobedo%2066054+(My%20Business%20Name)&amp;ie=UTF8&amp;t=&amp;z=14&amp;iwloc=B&amp;output=embed"/>
                      </ContactCol>
                    </FormRow>
                  </AnimationContainer>
                  <IconRow>
                        ...
                        <AnimationContainer animation="fadeIn" delay={500}>
                          <InfoPart>
                            ...
                            <Info>
                              ...
                              <InfoLinkContainer>
                                <InfoLink href="mailto:armand716@hotmail.com">
                                  armand716@hotmail.com
                                </InfoLink>
                              </InfoLinkContainer>
                            </Info>
                          </InfoPart>
                        ...
                        <AnimationContainer animation="fadeIn" delay={1000}>
                          <InfoPart>
                            ...
                            <Info>
                              ...
                              <InfoLinkContainer>
                                <InfoLink href="tel:+52(81)8117-1195">
                                  (81) 8117-1195
                                </InfoLink>
                              </InfoLinkContainer>
                            </Info>
                        ...
                        <AnimationContainer animation="fadeIn" delay={1500}>
                          <InfoPart>
                            ...
                            <Info>
                              ...
                              <InfoLinkContainer>
                                <InfoLink target="_blank" href="https://goo.gl/maps/Ldg5C8nZjMaAicfbA">
                                  Privada Mariano Escobedo
                                </InfoLink>
                              </InfoLinkContainer>
                            </Info>
                          </InfoPart>
...
export default props => (
  <StaticQuery
    query={graphql`
    query {
      emailIcon: file(relativePath: {eq: "icons/email2 (1).png"}) {
        childImageSharp {
          fluid(maxWidth: 500) {
            src
          }
      ...
      mapIcon: file(relativePath: {eq: "icons/map (1).png"}) {
        childImageSharp {
          fluid(maxWidth: 500) {
            src
          }
      ...
      phoneIcon: file(relativePath: {eq: "icons/phone (1).png"}) {
        childImageSharp {
          fluid(maxWidth: 500) {
            src
          }
